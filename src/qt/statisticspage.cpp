...
void StatisticsPage::updateStatistics()
{
  ...
  /*  if(nSubsidy < rewardPrevious)
   ...
   /* if(pHardness > hardnessPrevious)
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " XG" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " XG" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " XG");
    }
